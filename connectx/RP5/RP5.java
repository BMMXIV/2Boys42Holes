 ...
 * 
 */
public class RP5 implements CXPlayer {
	private Random rand;
	...
	public int selectColumn(CXBoard B) {
		...
		try {
			...
			System.err.println("Timeout RP5");
			return score.column;
		}
	}
	...
	public String playerName() {
		return Integer.toString(prune) + " Visited Nodes: " + Integer.toString(nodes) +" Rdy Player 5";
	}
}
